...
// DFS Approach
// Using Recursion
// Time Complexity : O(N), Where is the total number of nested elements in the input list, i.e [ [[[[1]]]], 2] contains 4 nested lists and 2 nested integers, so N = 6 in this case
